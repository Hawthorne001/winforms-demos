...
namespace ColumnStyles
{
    ...
    public class Form1 : GridDemoForm
    {
        ...
        public Form1()
        {
            ...
            bl.Add(new CustomClass(0145, r.Next(10), "Røgede sild", r.Next(100), r.Next(-100, 100)));
            ...
            bl.Add(new CustomClass(0155, r.Next(10), "Tourtière", r.Next(100), r.Next(-100, 100)));
            ...
            bl.Add(new CustomClass(0172, r.Next(10), "Fløtemysost", r.Next(100), r.Next(-100, 100)));
            ...
            bl.Add(new CustomClass(0179, r.Next(10), "Tourtière", r.Next(100), r.Next(-100, 100)));
